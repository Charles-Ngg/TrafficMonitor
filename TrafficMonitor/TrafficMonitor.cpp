...
void CTrafficMonitorApp::LoadConfig()
{
    ...
    m_general_data.cpu_temp_warn.enable = ini.GetBool(L"notify_tip", L"cpu_temperature_warn_enable", false);
    m_general_data.cpu_temp_warn.tip_value = ini.GetInt(L"notify_tip", L"cpu_temperature_warn_value", 90);
    m_general_data.cpu_temp_shutdown.enable = ini.GetBool(L"notify_tip", L"cpu_temperature_shutdown_enable", false);
    m_general_data.cpu_temp_shutdown.tip_value = ini.GetInt(L"notify_tip", L"cpu_temperature_shutdown_value", 100);
    ...
    m_general_data.gpu_temp_warn.enable = ini.GetBool(L"notify_tip", L"gpu_temperature_warn_enable", false);
    m_general_data.gpu_temp_warn.tip_value = ini.GetInt(L"notify_tip", L"gpu_temperature_warn_value", 90);
    m_general_data.gpu_temp_shutdown.enable = ini.GetBool(L"notify_tip", L"gpu_temperature_shutdown_enable", false);
    m_general_data.gpu_temp_shutdown.tip_value = ini.GetInt(L"notify_tip", L"gpu_temperature_shutdown_value", 100);
...
void CTrafficMonitorApp::SaveConfig()
{
    ...
    ini.WriteBool(L"notify_tip", L"cpu_temperature_warn_enable", m_general_data.cpu_temp_warn.enable);
    ini.WriteInt(L"notify_tip", L"cpu_temperature_warn_value", m_general_data.cpu_temp_warn.tip_value);
    ini.WriteBool(L"notify_tip", L"cpu_temperature_shutdown_enable", m_general_data.cpu_temp_shutdown.enable);
    ini.WriteInt(L"notify_tip", L"cpu_temperature_shutdown_value", m_general_data.cpu_temp_shutdown.tip_value);
    ...
    ini.WriteBool(L"notify_tip", L"gpu_temperature_warn_enable", m_general_data.gpu_temp_warn.enable);
    ini.WriteInt(L"notify_tip", L"gpu_temperature_warn_value", m_general_data.gpu_temp_warn.tip_value);
    ini.WriteBool(L"notify_tip", L"gpu_temperature_shutdown_enable", m_general_data.gpu_temp_shutdown.enable);
    ini.WriteInt(L"notify_tip", L"gpu_temperature_shutdown_value", m_general_data.gpu_temp_shutdown.tip_value);
